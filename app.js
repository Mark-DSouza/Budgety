...
var budgetController = (function(){
    ...
    return {
        ...
        deleteItem: function(type, id){
            ...
            // Create an array that holds all the ids of the objects in the data structure
            ...
            // Remove the element from the data structure if index is valid
            if (index !== -1){
...
var UIController = ( function(){
    ...
    return {
        ...
        changedType: function(){
            var nodeList = document.querySelectorAll(DOMstrings.inputType + ','
